...
try:
    vo_list = [
        "alice", "atlas", "cms", "lhcb", "hone", "ilc", "mice", "minos",
    ...
    for vo in vo_list:
        ...
        # get a searchReference integer and use the ldap module to get the
        # result from the search reference.
        ...
        # rows is a list of dictionaries like below. I think each row is called
        # a 'Disk Pool'
        # {'GlueSATotalNearlineSize': ['1441'],
        #  'GlueSATotalOnlineSize': ['11183'],
        ...
        for row in rows:
            ...
            # <total tape used>
            thisRow = []
            # each vo is one row of content, thisRow will eventually be
            # appended onto jsonObj[0]["rows"]
        ...
        thisPath = BASE_PATH + "storageUsage" + vo.capitalize() + "/query"
        writeFileWithLog(thisPath, json.dumps(jsonObj))
